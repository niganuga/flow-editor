...
export function BackgroundCanvas() {
  ...
  return (
    <>
      {/* Full-screen background canvas - z-10 */}
      <div
      ...
      >
        {imageUrl ? (
          ...
          <div
            ...
            className="h-full w-full flex flex-col items-center justify-center gap-4 p-8 cursor-pointer hover:bg-accent/10 transition-colors"
          >
            <Upload className="w-24 h-24" strokeWidth={1.5} />
            <div className="text-center">
              <p className="font-bold text-2xl mb-2">Upload Image</p>
              <p className="text-sm text-muted-foreground mb-1">Click anywhere or drag and drop to upload</p>
      ...
      {/* Floating controls - z-20 - Only show when image is uploaded */}
      {imageUrl && (
        <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-20 flex items-center gap-2">
          {/* Zoom Controls */}
          <div className="flex items-center gap-1 bg-card border-2 border-foreground rounded-lg p-1 h-9 shadow-lg">
            <Button
              variant="ghost"
              size="icon"
              className="h-7 w-7"
          ...
          <div className="h-9 flex items-center">
            <Button variant="outline" className="brutalist-button h-full shadow-lg" onClick={handleReplaceClick}>
              Replace File
            </Button>
          </div>
        </div>
